...
def getGasPrices():
    try:
        ...
        euroPrices["standard"] = etherPrices["standard"] * int(conversionRateE)
        euroPrices["slow"] = etherPrices["slow"] * int(conversionRateE)
        euroPrices["fast"] = etherPrices["fast"] * int(conversionRateE)
        euroPrices["rapid"] =  etherPrices["rapid"] * int(conversionRateE)
